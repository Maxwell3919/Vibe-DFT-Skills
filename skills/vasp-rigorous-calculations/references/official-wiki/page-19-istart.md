...
- Official URL: https://www.vasp.at/wiki/ISTART
- Page ID: 19
- Revision ID: 37120
...
Same as ISTART=2 but in addition a valid TMPCAR file must exist, containing the positions and orbitals at time steps [math]\displaystyle{ t(N-1) }[/math] and [math]\displaystyle{ t(N-2) }[/math], which are needed for the orbital and charge prediction scheme (used for MD-runs).
...
CHGCAR, TAUCAR, ICHARG, LCHARG, LMAXMIX, NELMDL, INIWAV, GAMMA, vaspgamma.h5
