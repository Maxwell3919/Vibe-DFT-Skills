...
- Official URL: https://www.vasp.at/wiki/ISYM
- Page ID: 296
- Revision ID: 26986
...
For ISYM=0, VASP does not use symmetry, but it will assume that Ψk=Ψ*-k and reduces the sampling of the Brillouin zone accordingly. This value should be set for molecular dynamics, i.e. IBRION=0.
