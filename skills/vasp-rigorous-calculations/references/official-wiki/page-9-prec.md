...
- Official URL: https://www.vasp.at/wiki/PREC
- Page ID: 9
- Revision ID: 31482
...
Default values set by PREC[edit | edit source]
...
Normal
max(ENMAX)
3/2×[math]\displaystyle{ G_{\rm cut} }[/math]
2×NGX
-5×10-4
1.0
...
Single (VASP.6)
max(ENMAX)
2×[math]\displaystyle{ G_{\rm cut} }[/math]
NGX
-5×10-4
1.0
...
max(ENMIN)
3/2×[math]\displaystyle{ G_{\rm cut} }[/math]
3×[math]\displaystyle{ G_{\rm aug} }[/math]
-1×10-2
2/3
...
max(ENMAX)
3/2×[math]\displaystyle{ G_{\rm cut} }[/math]
4×[math]\displaystyle{ G_{\rm aug} }[/math]
-2×10-3
1.0
...
1.3×max(ENMAX)
2×[math]\displaystyle{ G_{\rm cut} }[/math]
16/3×[math]\displaystyle{ G_{\rm aug} }[/math]
-4×10-4
1.5

where max(ENMAX) and max(ENMIN) are the maxima of ENMAX and ENMIN found in the POTCAR file, and [math]\displaystyle{ G_{\rm cut} }[/math] and [math]\displaystyle{ G_{\rm aug} }[/math] are defined by
...
Further remarks[edit | edit source]
