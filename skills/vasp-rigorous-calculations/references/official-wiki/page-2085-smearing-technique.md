...
- Official URL: https://www.vasp.at/wiki/Smearing_technique
- Page ID: 2085
- Revision ID: 37503
...
- 2 Broadening techniques

- 2.1 Gaussian broadening

- 2.2 Methfessel-Paxton broadening

- 2.3 Fermi-Dirac broadening

- 3 Tetrahedron methods

- 4 Calculation of the Fermi energy

- 5 Which method to use

- 6 Other methods

- 7 Related tags and articles

- 8 References

How to set ISMEAR[edit | edit source]
...
Broadening techniques[edit | edit source]
...
Gaussian broadening[edit | edit source]
...
Methfessel-Paxton broadening[edit | edit source]
...
Fermi-Dirac broadening[edit | edit source]
...
Tetrahedron methods[edit | edit source]
...
In bulk materials, we recommend the tetrahedron method with Blöchl corrections[1] (ISMEAR=-5) for the calculation of very precise total energies or the electronic density of states (DOS).
...
Calculation of the Fermi energy[edit | edit source]
...
Which method to use[edit | edit source]
