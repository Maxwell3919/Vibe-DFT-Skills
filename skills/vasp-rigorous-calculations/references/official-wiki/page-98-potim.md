...
- Official URL: https://www.vasp.at/wiki/POTIM
- Page ID: 98
- Revision ID: 27209
...
must be set if IBRION= 0 (MD)

= 0.5

if IBRION= 1, 2, and 3 (ionic relaxation), and 5 (up to VASP.4.6)

= 0.015

if IBRION=5, and 6 (as of VASP.5.1)
