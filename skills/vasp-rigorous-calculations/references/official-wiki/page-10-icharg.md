...
- Official URL: https://www.vasp.at/wiki/ICHARG
- Page ID: 10
- Revision ID: 37119
...
When METAGGA is performed VASP also reads the TAUCAR file if present. The kinetic energy density from TAUCAR is used to initialize meta-GGA calculations. Warning: if no TAUCAR file is present, VASP will start with an empty kinetic energy density that is updated upon the first charge density update after the NELMDL delay phase.
...
CHGCAR, TAUCAR, ISTART, LCHARG, LMAXMIX, NELMDL, INIWAV, GAMMA, vaspgamma.h5
