...
```bash
python3 tools/sync_official_manual_cache.py --refresh --skill dft-structure-preparation
...
Read the generated `index.md` under `${XDG_CACHE_HOME:-$HOME/.cache}/vibe-dft-skills/official-manuals/dft-structure-preparation/`. Keep the official URL, authority/version identity, and local conversion label in every claim. A cache pass proves document identity and readability only; it does not prove executable behavior, convergence, physical validity, or permission to redistribute the cached body.

This Skill has 4 registered source records across these authorities:

- `ase-release-source-docs-3-29-0`
- `pymatgen-release-source-docs-2026-5-4`
- `rdkit-release-source-docs-2026-03-4`
